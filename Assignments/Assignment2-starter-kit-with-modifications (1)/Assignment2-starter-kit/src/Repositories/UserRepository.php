...
{
    /**
     * Gets the user object from the database using ID
     */
    ...
    /**
     * Saves a new user to the database (used to register users)
     * @param string $name
     * @param string $email
    ...
    /**
     * updates user data with matching ID in the database 
     * @param int $id
     * @param string $name
