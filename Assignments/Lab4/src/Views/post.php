...
$post = (new PostRepository('localhost', 'root', 'posts_web_app', ''))->getPostById((int)$_GET['id']);
?>
<!doctype html>
<html lang="en">
        ...
        <div class="bg-white shadow sm:rounded-lg">
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-2 max-w-xl text-sm text-gray-500">
                    <small>Posted <?= $post->createdAtFmt(); ?></small>
					<?php if ($post->updated_at !== null): ?>
                        <div>
                            <small>Edited on <?= $post->updatedAtFmt(); ?></small>
                        </div>
					<?php endif; ?>
                </div>
